...
docker build --no-cache -t $DOCKER_USER/fraud-det-v3-data-prep:cpu -f pods/data-prep/Dockerfile.cpu .
docker push $DOCKER_USER/fraud-det-v3-data-prep:cpu

docker build --no-cache -t $DOCKER_USER/fraud-det-v3-inference:cpu -f pods/inference/Dockerfile.cpu .
docker push $DOCKER_USER/fraud-det-v3-inference:cpu

docker build --no-cache -t $DOCKER_USER/fraud-det-v3-data-prep:gpu -f pods/data-prep/Dockerfile.gpu .
docker push $DOCKER_USER/fraud-det-v3-data-prep:gpu

docker build --no-cache -t $DOCKER_USER/fraud-det-v3-model-build:gpu -f pods/model-build/Dockerfile .
docker push $DOCKER_USER/fraud-det-v3-model-build:gpu

docker build --no-cache -t $DOCKER_USER/fraud-det-v3-inference:latest -f pods/inference/Dockerfile .
